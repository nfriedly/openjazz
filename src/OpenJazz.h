...
#endif
#else
// #define CONFIG_FILE "openjazz.cfg"  //amended to allow packaging to opk format for gcw
#define CONFIG_FILE "/mnt/.openjazz/openjazz.cfg"
#endif
#define LOGO_FILE   "openjazz.000"
#define LEVEL_FILE  "/mnt/.openjazz/openjazz.tmp"
