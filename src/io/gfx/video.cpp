...
//	if (fullscreen) SDL_ShowCursor(SDL_DISABLE); to get rid of gcw cursor
...
#if defined(CAANOO) || defined(WIZ) || defined(GP2X) || defined(DINGOO)
//	screen = SDL_SetVideoMode(320, 240, 8, FULLSCREEN_FLAGS);   //changed for gcw, fix whitebar issue

	screen = SDL_SetVideoMode(320, screenH, 8, FULLSCREEN_FLAGS);
#else
