...
// make .openjazz dir for gcw
mkdir("/mnt/.openjazz",S_IRWXU);
//	system(mkdir "/usr/local/home/.openjazz",S_IRWXUmkdir );
	...
	fprintf(stderr, "archivo: %s", F_PANEL);
	try {
